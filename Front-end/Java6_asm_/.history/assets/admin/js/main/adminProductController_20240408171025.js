...
app.controller('AdminProductController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudProduct = function () {
        ...
        $scope.resetForm = function () {
            ...
            console.log("$scope.filenames lam moi", $scope.filenames);
            if ($scope.filenames.length > 0) {
                $scope.filenames.forEach(filename => console.log("filename,filename", filename))
            }
        }
    ...
    //     $scope.formProduct.selectedBrand = 1
    //     alert("Brand selected:" + $scope.formProduct.selectedBrand);
    // };
