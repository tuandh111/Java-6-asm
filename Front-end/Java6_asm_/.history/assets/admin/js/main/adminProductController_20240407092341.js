...
app.controller('AdminProductController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.getDiscountByProduct = function (product) {
        ...
        //console.log("$scope.infoProductRelative dss", $scope.infoProductRelative.discounts);
        $scope.temp = $scope.infoProductRelative.discounts.filter(discount => discount.product.productId === product.productId)[0].discountedPrice
        console.log("$scope.temp", $scope.temp);
        // return $scope.infoProductRelative.discounts.filter(prod => prod.product.productId === product.productId).discountedPrice;
    };
