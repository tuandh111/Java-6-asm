...
app.controller('AdminBrandController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudBrand = function () {
        ...
        $scope.createBrand = function () {
            ...
            $http.post(url + "/management/twobee/brands", { headers: headers }, requsetBrandJSON).then(
                respone => {
                    Swal.fire({
                        title: "Thành công!",
        ...
        $scope.updateBrand = function () {
            ...
            $http.put(url + "/management/twobee/brands/" + brandId, { headers: headers }, requsetBrandJSON).then(
                respone => {
