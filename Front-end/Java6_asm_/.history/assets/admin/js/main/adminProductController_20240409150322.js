...
app.controller('AdminProductController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudProduct = function () {
        ...
        $scope.editProduct = (product) => {
            ...
            // $scope.formProduct.selectedBrand = product.brand.brandId
            //console.log("$scope.formProduct.selectedBrand=product.brand.brandId", $scope.formProduct.selectedBrand);
            $scope.formProduct = {
                productId: product.productId,
