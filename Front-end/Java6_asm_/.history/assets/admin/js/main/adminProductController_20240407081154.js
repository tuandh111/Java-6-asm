...
app.controller('AdminProductController', function ($scope, $http, $rootScope, $location) {
    ...
    //         $scope.listProductImg = response.data.productImage
    ...
    $scope.listInfo = async function () {
        try {
            const response = await $http.get(url + '/products', { headers: headers });
            $scope.infoProductRelative = response.data;
            $scope.listProductImg = response.data.productImage;
    ...
    $scope.filterHandling = function () {
        console.log("$scope.listProductImg aaa", $scope.listProductImg);
    }

    $scope.listImg();
    $scope.listInfo();
    $scope.filterHandling();
})
