...
app.controller('AdminBrandController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudBrand = function () {
        ...
        $scope.createBrand = function () {
            ...
            console.log("requsetBrand", requsetBrand);
            console.log("requsetBrandJSON", requsetBrandJSON);
            // $http.post(url + "/api/v1/auth/twobee/brands", requsetBrand).then(
            //     respone => console.log("respone", respone)
