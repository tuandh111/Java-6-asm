...
app.controller('AdminBrandController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudBrand = function () {
        ...
        $scope.updateBrand = function () {
            var requsetBrandJSON = angular.toJson($scope.formBrand)
            var brandId = $scope.formBrand.brandId
            //  console.log(url + "/api/v1/auth/twobee/brands/" + brandId);
            $http.post(url + "/api/v1/auth/twobee/brands/" + brandId, requsetBrandJSON).then(
                respone => {
