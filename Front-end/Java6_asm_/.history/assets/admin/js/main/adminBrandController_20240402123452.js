...
app.controller('AdminBrandController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudBrand = function () {
        ...
        $scope.createBrand = function () {
            ...
            // console.log("create $scope.formBrand", requsetBrand);
            $http.post(url + "/twobee/brands", requsetBrand).then().catch(err => console.log("Error during post request for Brand", err))
        }
