...
app.controller('AdminBrandController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.getAllBrand = function () {
        $http.get(url + "/management/twobee/brands-and-count-product", headers).then(
            response => {
    ...
    $scope.crudBrand = function () {
        ...
        $scope.createBrand = function () {
            ...
            $http.post(url + "/management/twobee/brands", headers, requsetBrandJSON).then(
                respone => {
                    Swal.fire({
                        title: "Thành công!",
        ...
        $scope.updateBrand = function () {
            ...
            $http.put(url + "/management/twobee/brands/" + brandId, headers, requsetBrandJSON).then(
                respone => {
        ...
        $scope.deleteBrand = function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $http.delete(url + "/management/twobee/brands/" + brandId, headers).then(
                        respone => {
                            $scope.resetForm();
                            Swal.fire({
                                title: "Thành công!",
        ...
        $scope.deleteBrandById = function (brand) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $http.delete(url + "/management/twobee/brands/" + idBrand, headers).then(
                        respone => {
                            $scope.resetForm();
                            Swal.fire({
                                title: "Thành công!",
