...
app.controller('AdminBrandController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.getAllBrand = function () {
        $http.get(url + "/twobee/brands-and-count-product").then(
            response => {
    ...
    $scope.crudBrand = function () {
        ...
        $scope.createBrand = function () {
            ...
            $http.post(url + "/twobee/brands", requsetBrandJSON).then(
                respone => {
                    Swal.fire({
                        title: "Thành công!",
        ...
        $scope.updateBrand = function () {
            ...
            $http.put(url + "/twobee/brands/" + brandId, requsetBrandJSON).then(
                respone => {
        ...
        $scope.deleteBrand = function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $http.delete(url + "/twobee/brands/" + brandId).then(
                        respone => {
                            $scope.resetForm();
                            Swal.fire({
                                title: "Thành công!",
        ...
        $scope.deleteBrandById = function (brand) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $http.delete(url + "/twobee/brands/" + idBrand).then(
                        respone => {
                            $scope.resetForm();
                            Swal.fire({
                                title: "Thành công!",
