...
app.controller('AdminBrandController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudBrand = function () {
        ...
        $scope.updateBrand = function () {
            ...
            $http.put(url + "/api/v1/auth/twobee/brands/" + brandId, requsetBrandJSON).then(
                respone => {
        ...
        $scope.deleteBrand = function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $http.delete(url + "/api/v1/auth/twobee/brands/" + brandId).then(
                        respone => {
                            $scope.resetForm();
                            Swal.fire({
                                title: "Thành công!",
        ...
        $scope.deleteBrandById = function (brand) {
            var brandId = brand.brand.brandId
            var brandName = brand.brand.brandName
            //var brandId = $scope.formBrand.brandId === undefined ? -1 : $scope.formBrand.brandId;
            Swal.fire({
