...
app.controller('AdminProductController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudProduct = function () {
        ...
        $scope.updateProduct = function () {
            ...
            console.log(requsetProductJSON);
            //console.log("Sizeeee", size);
            // $scope.formProduct.selectedBrand = $scope.getBrand();
            // console.log("$scope.formProduct.selectedBrand", $scope.formProduct.selectedBrand);
        }
    }
    ...
    $scope.getSize = function () {
        return $scope.formProduct.selectedSizes;
    };
    $scope.getColor = function () {
        return $scope.formProduct.selectedColors;
    }
