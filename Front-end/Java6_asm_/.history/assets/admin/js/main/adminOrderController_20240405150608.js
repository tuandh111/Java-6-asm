...
app.controller('AdminOrderController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.getOrders = function () {
        $http.get(url + "/twobee/orders").then(respone => {
    ...
    $scope.getCarts = function () {
        $http.get(url + "/twobee/carts").then(respone => {
    ...
    $scope.getSizes = function () {
        $http.get(url + "/twobee/sizes").then(respone => {
    ...
    $scope.getColors = function () {
        $http.get(url + "/twobee/colors").then(respone => {
                ...
                if (rs.isConfirmed) {
                    Swal.fire({
                        ...
                        if (reason.dismiss === Swal.DismissReason.cancel) {
                            ...
                            $http.put(url + "/twobee/orders/" + orderId, requsetOrderJSON).then(
                                respone => {
