...
app.controller('AdminProductController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.getImageByProduct = function (productId) {
        let productImages = $scope.infoProductRelative.productImages.filter(prodImg => prodImg.product.productId === productId);
    ...
    $scope.getDiscountByProduct = function (productId) {
        let discounts = $scope.infoProductRelative.discounts.filter(discount => discount.product.productId === productId)
