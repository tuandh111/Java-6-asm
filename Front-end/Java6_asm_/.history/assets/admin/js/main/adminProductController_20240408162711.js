...
app.controller('AdminProductController', function ($scope, $http, $rootScope, $location) {
    ...
    $scope.crudProduct = function () {
        $scope.formProduct = {
            ...
            selectedBrand: "",
            // selectedSizes: 37,
            // selectedColors: { "colorId": 1, colorName: "black" },
            quantityInStock: 0,
            price: 0,
            discount: 0,
            isActive: true
        ...
        $scope.editProduct = (product) => {
            ...
            $scope.formProduct = {
                ...
                selectedBrand: product.brand.brandId,
                // selectedSizes: 37,
                // selectedColors: { "colorId": 1, colorName: "black" },
        ...
        //     console.log("Color selected:", $scope.formProduct.selectedColors);
        // };
        $scope.getBrand = function () {
            console.log("Color selected:", $scope.formProduct.selectedBrand);
        };
    }
