...
function QuestionController($scope, $http, $routeParams, $rootScope, $interval) {
    ...
    $http({
        ...
        // *$scope.listQuestion.length;
        $scope.totalQuizTime = 5
        ...
        let totalQuizTimeMilliseconds = $scope.totalQuizTime * 1000;
        $scope.quizEndTime = new Date();
        $scope.quizEndTime.setMilliseconds(quizEndTime.getMilliseconds() + totalQuizTimeMilliseconds);
