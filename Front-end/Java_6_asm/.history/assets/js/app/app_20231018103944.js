...
function QuestionController($scope, $http, $routeParams, $rootScope,$interval) {
    ...
    $http({
        ...
        $rootScope.totalQuestion=$scope.listQuestion.length;
    ...
    $scope.totalQuizTime = 1500; // Total quiz time in seconds (e.g., 1500 seconds for 50 questions)
