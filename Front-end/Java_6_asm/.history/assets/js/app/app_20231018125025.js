...
$scope.posts = [
    {
        ...
        description:"Chào bạn! Nếu bạn đã là học viên khóa Pro của F99, chắc hẳn bạn đã biết tới Dev Mode - giúp thực hành code song song khi xem video (bạn không cần phải dùng tới VS code nữa)."
    },
    {
        id:"post2",
    ...
    },
    {
        ...
        description:"Bài viết này đơn giản là nơi để mình lưu lại những kinh nghiệm mình đã làm việc với HTML/CSS cũng như chia sẻ phần nào cho bạn nào chưa biết. Mình cùng bắt đầu bài viết thôi, yooolo"
    },
    {
        id:"post4",
        image:"assets/images/post/4.jpg",
        title:"Đánh giá ÉP CHÍN CHÍN với một số trường",
        description:"Flex về F99 nhẹ xíu cho mọi người cùng biết nhé!!"
    }
