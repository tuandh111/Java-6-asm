...
function LoginController($scope) {
    ...
    $scope.login = function () {
       ...
       console.log( $scope.students[0].fullname);
       console.log( $scope.students[0].fullname == $scope.user.loginName);
        // $scope.students.forEach(element => {
        //     if (element.username == user.loginName && element.password == user.loginPass) {
        //         console.log("OK");
        //     }else{
        //         console.log("KO");
        //     }
